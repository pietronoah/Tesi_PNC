...
std::vector<long long int> pattern_merge(std::vector<long long int> a, std::vector<long long int> b) {
    ...
    for(int i = 0; i <n_col; i++) {
        ...
        /*for(int j = 0; j < patt1.size(); j++) {
            if(patt1[j] < i) {
                //std::cout << "Ciao: " << j << std::endl;
                patt1.erase(patt1.begin()+j);
            }
        }*/

        /*for(std::vector<long long int>::iterator j = patt1.begin(); j != patt1.end(); ++j) {
            if(*j < i) patt1.erase(j);
        }*/
...
//-----------------------------------------------------------------------
    ...
    std::vector<long long int> test_hes(sparsity_pattern, sparsity_pattern + 23);
    ...
    std::cout << "-----------------------------------------------" << std::endl;
    pattern_value_match_hessian(test_hes2,values2,final_pattern,final_values,2);
