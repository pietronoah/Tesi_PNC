...
bool HS071_NLP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  ...
  auto d_f = derivativesx(f(p), wrt(p[0], p[1]));
                           ...
                           Number* values)
{
  if (values == NULL) {
    ...
    auto d_g_0 = derivativesx(g_0(p), wrt(p[0], p[1]));
    
    auto d_g_1 = derivativesx(g_1(p), wrt(p[0], p[1]));
                       ...
                       Index* jCol, Number* values)
{
  if (values == NULL) {
    ...
    auto dd_f0 = derivativesx(d_f[0], wrt(p[0], p[1]));
    
    auto dd_f1 = derivativesx(d_f[1], wrt(p[0], p[1]));
    ...
    auto dd_g_00 = derivativesx(d_g_0[0], wrt(p[0], p[1]));
    auto dd_g_01 = derivativesx(d_g_0[1], wrt(p[0], p[1]));
    ...
    auto dd_g_10 = derivativesx(d_g_1[0], wrt(p[0], p[1]));
    auto dd_g_11 = derivativesx(d_g_1[1], wrt(p[0], p[1]));
