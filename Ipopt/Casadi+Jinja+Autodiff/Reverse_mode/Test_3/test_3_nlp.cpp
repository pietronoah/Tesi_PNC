...
var f(var* x)
{
  return pow(x[0]-1,2) + pow(x[0]-x[1],2) + pow(x[1]-x[2],2) + pow(x[2]-x[3],4) + pow(x[3]-x[4],4);
}


var g_0(var* x)
{
  return x[0] + pow(x[1],2) + pow(x[2],3);
}

var g_1(var* x)
{
  return x[1] -  pow(x[2], 2) + x[3];
}
...
bool HS071_NLP::eval_grad_f(Index n, const Number* x, bool new_x, Number* grad_f)
{
  ...
  auto d_f = derivativesx(f(p), wrt(p[0], p[1], p[2], p[3], p[4]));
                           ...
                           Number* values)
{
  if (values == NULL) {
    ...
    auto d_g_0 = derivativesx(g_0(p), wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto d_g_1 = derivativesx(g_1(p), wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto d_g_2 = derivativesx(g_2(p), wrt(p[0], p[1], p[2], p[3], p[4]));
                       ...
                       Index* jCol, Number* values)
{
  if (values == NULL) {
    ...
    auto dd_f0 = derivativesx(d_f[0], wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto dd_f1 = derivativesx(d_f[1], wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto dd_f2 = derivativesx(d_f[2], wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto dd_f3 = derivativesx(d_f[3], wrt(p[0], p[1], p[2], p[3], p[4]));
    
    auto dd_f4 = derivativesx(d_f[4], wrt(p[0], p[1], p[2], p[3], p[4]));
    ...
    auto dd_g_00 = derivativesx(d_g_0[0], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_01 = derivativesx(d_g_0[1], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_02 = derivativesx(d_g_0[2], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_03 = derivativesx(d_g_0[3], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_04 = derivativesx(d_g_0[4], wrt(p[0], p[1], p[2], p[3], p[4]));
    ...
    auto dd_g_10 = derivativesx(d_g_1[0], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_11 = derivativesx(d_g_1[1], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_12 = derivativesx(d_g_1[2], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_13 = derivativesx(d_g_1[3], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_14 = derivativesx(d_g_1[4], wrt(p[0], p[1], p[2], p[3], p[4]));
    ...
    auto dd_g_20 = derivativesx(d_g_2[0], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_21 = derivativesx(d_g_2[1], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_22 = derivativesx(d_g_2[2], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_23 = derivativesx(d_g_2[3], wrt(p[0], p[1], p[2], p[3], p[4]));
    auto dd_g_24 = derivativesx(d_g_2[4], wrt(p[0], p[1], p[2], p[3], p[4]));
