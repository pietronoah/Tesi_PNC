...
objective1 = "-0.5*(x[0]*x[3]-x[1]*x[2]+x[2]*x[8]-x[4]*x[8]+x[4]*x[7]-x[5]*x[6])"
constrains1 = [None] * m
constrains1[0] = "1 - pow(x[2],2) - pow(x[3],2)"
constrains1[1] = "1 - pow(x[4],2) - pow(x[5],2)"
constrains1[2] = "1 - pow(x[8],2)"
constrains1[3] = "1 - pow(x[0],2) - pow(x[1]-x[8],2)"
constrains1[4] = "1 - pow(x[0]-x[4],2) - pow(x[1]-x[5],2)"
constrains1[5] = "1 - pow(x[0]-x[6],2) - pow(x[1]-x[7],2)"
constrains1[6] = "1 - pow(x[2]-x[6],2) - pow(x[3]-x[7],2)"
constrains1[7] = "1 - pow(x[2]-x[4],2) - pow(x[3]-x[5],2)"
constrains1[8] = "1 - pow(x[6],2) - pow(x[7]-x[8],2)"
constrains1[9] = "x[0]*x[3]-x[1]*x[2]"
constrains1[10] = "x[2]*x[8]"
constrains1[11] = "-x[4]*x[8]"
constrains1[12] = "x[4]*x[7]-x[5]*x[6]"
constrains1[13] = "x[8]"
