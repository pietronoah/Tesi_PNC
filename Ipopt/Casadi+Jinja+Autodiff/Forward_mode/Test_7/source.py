...
objective1 = "pow(x[0],2) + 0.5*pow(x[1],2) + pow(x[2],2) + 0.5*pow(x[3],2) - x[0]*x[2] + x[2]*x[3] - x[0] - 3*x[1] + x[2] - x[3]"
constrains1 = [None] * m
constrains1[0] = "x[0] + 2*x[1] + x[2] + x[3]"
constrains1[1] = "3*x[0] + x[1] + 2*x[2] - x[3]"
constrains1[2] = "x[1] + 4*x[2]"
...
objective = pow(x[0],2) + 0.5*pow(x[1],2) + pow(x[2],2) + 0.5*pow(x[3],2) - x[0]*x[2] + x[2]*x[3] - x[0] - 3*x[1] + x[2] - x[3]


# Definition of constrain functions
constrains[0] = x[0] + 2*x[1] + x[2] + x[3]
constrains[1] = 3*x[0] + x[1] + 2*x[2] - x[3]
constrains[2] = x[1] + 4*x[2]
