...
objective1 = "pow(x[0]-1,2) + pow(x[0]-x[1],2) + pow(x[1]-x[2],2) + pow(x[2]-x[3],4) + pow(x[3]-x[4],4)"
constrains1 = [None] * m
constrains1[0] = "x[0] + pow(x[1],2) + pow(x[2],3)"
constrains1[1] = "x[1] -  pow(x[2], 2) + x[3]"
constrains1[2] = "x[0] * x[4]"
